...
class TestDefend(TestCase):
    ...
    def test_defend_print_output_when_miss(self, mock_input, mock_stdout):
    ...
    def test_defend_print_output_when_hit_and_character_survives(self, mock_input, mock_stdout):
    ...
    def test_defend_print_output_when_hit_and_character_dies(self, mock_input, mock_stdout):
    ...
    def test_defend_when_hit_damage_is_reflected_in_new_hp(self, mock_input):
        hp_before_attack = rebel["HP"]
        defend(0)
        self.assertEqual(rebel["HP"], hp_before_attack - 2)

    @patch('battle.randint', side_effect=[3, 4])
    def test_defend_when_miss_hp_is_unchanged(self, mock_input):
        hp_before_attack = rebel["HP"]
        defend(1)
